          ...
          <div className="wwd-box flex flex-row items-center space-x-24">
            ...
            <div className="wwd-text w-96 leading-7">
              ...
              <p className="font-light">
                PEHO provides health and educational facilities Through
                vocational trainings, workshops, seminars, presentations,
                event’s, short and long courses and Implement health and
                educational professional projects.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="wwo-box flex flex-row justify-center space-x-40">
            ...
            <div className="wwo-content w-96">
              <h2 className="text-4xl mb-12 font-bold">
                WHERE WE{" "}
                <span className="text-bg-primary font-bold">OPERATE?</span>
              </h2>
